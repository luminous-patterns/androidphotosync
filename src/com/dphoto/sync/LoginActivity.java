...
public class LoginActivity extends Activity {
	...
	private static final String[] DUMMY_CREDENTIALS = new String[] {
			"mycetophorae:hello", "henry:aloha" };
...
//	}
	 ...
	 * the user.
	 */
	public class UserLoginTask extends OAuthTask {
		...
		protected void onPostExecute(final Boolean success) {
			...
			try {
				...
				if (jsonResponse.has("status") && jsonResponse.getString("status") != "error") {
					...
					editor.putString("dphoto_username", mUsername);
					editor.putString("dphoto_password", mPassword);
					editor.commit();
					validResponse = true;
				}
				else {
					Log.e(UserLoginTask.class.toString(), "API Error " + jsonResponse.getString("message"));
				}
